...
const PrimitiveClose = withUniwind(DialogPrimitive.Close);
const PrimitiveContent = withUniwind(DialogPrimitive.Content);
const PrimitiveDescription = withUniwind(DialogPrimitive.Description);
const PrimitiveOverlay = withUniwind(DialogPrimitive.Overlay);
const PrimitiveTitle = withUniwind(DialogPrimitive.Title);
