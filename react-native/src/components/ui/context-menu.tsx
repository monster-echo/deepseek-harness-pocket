...
const PrimitiveCheckboxItem = withUniwind(ContextMenuPrimitive.CheckboxItem);
const PrimitiveContent = withUniwind(ContextMenuPrimitive.Content);
const PrimitiveItem = withUniwind(ContextMenuPrimitive.Item);
const PrimitiveItemIndicator = withUniwind(ContextMenuPrimitive.ItemIndicator);
const PrimitiveLabel = withUniwind(ContextMenuPrimitive.Label);
const PrimitiveOverlay = withUniwind(ContextMenuPrimitive.Overlay);
const PrimitivePortal = withUniwind(ContextMenuPrimitive.Portal);
const PrimitiveRadioItem = withUniwind(ContextMenuPrimitive.RadioItem);
const PrimitiveSeparator = withUniwind(ContextMenuPrimitive.Separator);
const PrimitiveSubContent = withUniwind(ContextMenuPrimitive.SubContent);
const PrimitiveSubTrigger = withUniwind(ContextMenuPrimitive.SubTrigger);
