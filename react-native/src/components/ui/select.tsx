...
const PrimitiveContent = withUniwind(SelectPrimitive.Content);
const PrimitiveItem = withUniwind(SelectPrimitive.Item);
const PrimitiveItemIndicator = withUniwind(SelectPrimitive.ItemIndicator);
const PrimitiveItemText = withUniwind(SelectPrimitive.ItemText);
const PrimitiveLabel = withUniwind(SelectPrimitive.Label);
const PrimitiveOverlay = withUniwind(SelectPrimitive.Overlay);
const PrimitivePortal = withUniwind(SelectPrimitive.Portal);
const PrimitiveScrollDownButton = withUniwind(SelectPrimitive.ScrollDownButton);
const PrimitiveScrollUpButton = withUniwind(SelectPrimitive.ScrollUpButton);
const PrimitiveSeparator = withUniwind(SelectPrimitive.Separator);
const PrimitiveTrigger = withUniwind(SelectPrimitive.Trigger);
const PrimitiveValue = withUniwind(SelectPrimitive.Value);
const PrimitiveViewport = withUniwind(SelectPrimitive.Viewport);
...
function SelectContent({
  ...
  return (
    <PrimitivePortal hostName={portalHost}>
      <FullWindowOverlay>
        <PrimitiveOverlay
...
function SelectItem({
  ...
  return (
    <PrimitiveItem
      ...
      <PrimitiveItemText className="text-foreground group-active:text-accent-foreground select-none text-sm" />
    </PrimitiveItem>
  );
}
