...
const PrimitiveContent = withUniwind(TabsPrimitive.Content);
const PrimitiveList = withUniwind(TabsPrimitive.List);
const PrimitiveRoot = withUniwind(TabsPrimitive.Root);
const PrimitiveTrigger = withUniwind(TabsPrimitive.Trigger);

function Tabs({
  className,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.Root>) {
  return <PrimitiveRoot className={cn('flex flex-col gap-2', className)} {...props} />;
}
