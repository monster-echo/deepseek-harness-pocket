...
export function profileDir(profile = COMPANION_PROFILE) {
...
export function upsertBridgePatch(dir, config) {
...
export function installBridgePackage(dir, dshBin, packageRootPath) {
