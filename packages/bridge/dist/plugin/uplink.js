 ...
 */
import { parseGatewayToWorkerFrame, } from '@deepseek-harness-pocket/bridge-protocol';
        ...
        ws.on('message', (data) => {
            ...
            switch (frame.kind) {
                ...
                case 'pairing-challenge': {
                    ...
                    ctx.logger.info(`deepseek-harness-pocket pairing challenge from ${frame.requestedBy}: ${accepted ? 'accepted' : 'rejected (code mismatch)'}`);
                    break;
                }
            }
        });
