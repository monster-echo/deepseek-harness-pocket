...
const PrimitiveContent = withUniwind(AccordionPrimitive.Content);
const PrimitiveHeader = withUniwind(AccordionPrimitive.Header);
const PrimitiveItem = withUniwind(AccordionPrimitive.Item);
const PrimitiveRoot = withUniwind(AccordionPrimitive.Root);
const PrimitiveTrigger = withUniwind(AccordionPrimitive.Trigger);
...
function AccordionTrigger({
  ...
  return (
    <TextClassContext.Provider
      ...
      <PrimitiveHeader>
        <PrimitiveTrigger {...props} asChild={Platform.OS !== 'web'}>
          <Trigger
            className={cn(
