...
const PrimitiveCheckboxItem = withUniwind(MenubarPrimitive.CheckboxItem);
const PrimitiveContent = withUniwind(MenubarPrimitive.Content);
const PrimitiveItem = withUniwind(MenubarPrimitive.Item);
const PrimitiveItemIndicator = withUniwind(MenubarPrimitive.ItemIndicator);
const PrimitiveLabel = withUniwind(MenubarPrimitive.Label);
const PrimitivePortal = withUniwind(MenubarPrimitive.Portal);
const PrimitiveRadioItem = withUniwind(MenubarPrimitive.RadioItem);
const PrimitiveRoot = withUniwind(MenubarPrimitive.Root);
const PrimitiveSeparator = withUniwind(MenubarPrimitive.Separator);
const PrimitiveSubContent = withUniwind(MenubarPrimitive.SubContent);
const PrimitiveSubTrigger = withUniwind(MenubarPrimitive.SubTrigger);
const PrimitiveTrigger = withUniwind(MenubarPrimitive.Trigger);
...
function MenubarSeparator({
  ...
  return (
    <PrimitiveSeparator className={cn('bg-border -mx-1 my-1 h-px', className)} {...props} />
  );
}
