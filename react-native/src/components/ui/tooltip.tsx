...
const PrimitiveContent = withUniwind(TooltipPrimitive.Content);
const PrimitiveOverlay = withUniwind(TooltipPrimitive.Overlay);
const PrimitivePortal = withUniwind(TooltipPrimitive.Portal);
