...
const PrimitiveIndicator = withUniwind(ProgressPrimitive.Indicator);
const PrimitiveRoot = withUniwind(ProgressPrimitive.Root);
...
function WebIndicator({ value, className }: IndicatorProps) {
  ...
  return (
    <View
      ...
      <PrimitiveIndicator className={cn('h-full w-full', className)} />
    </View>
  );
}
