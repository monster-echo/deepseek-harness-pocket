  ...
  return (
    <View style={[styles.container, { backgroundColor: palette.surface }]}>
      ...
      <View style={styles.logoRow}>
        ...
        />
        <Text style={[styles.logoName, { color: palette.text }]}>
          掌鲸 DSH Pocket
        </Text>
      </View>
      ...
      <View style={styles.searchRow}>
        ...
        >
          <AppIcon name="search" color={palette.textSecondary} size={14} />
          <TextInput
      ...
      <View style={styles.midArea}>
        {activeWorkerId === null ? (
          ...
          >
            ...
            <Text style={[styles.noWorkerText, { color: palette.text }]}>
              还没有选择电脑
            </Text>
            <Text
              style={[styles.noWorkerSub, { color: palette.textSecondary }]}
            >
              点击选择或配对一台电脑
            </Text>
          </Pressable>
                  ...
                  <View key={group.key}>
                    <Pressable
                      ...
                      onLongPress={() =>
                        ...
                        setActionTarget(group.workspace)
                      }
                      delayLongPress={350}
                    >
                      {collapsed[group.key] ? (
      ...
      <View style={[styles.footer, { borderTopColor: palette.border }]}>
        <FooterEntry
          icon="settings"
          label={activeWorker !== undefined ? activeWorker.name : "选择电脑"}
          sub={
      ...
      >
        <Text
          style={[styles.viewSectionLabel, { color: palette.textSecondary }]}
        >
          分组
        </Text>
        <Pressable
      ...
      >
        ...
        >
          <AppIcon name="edit" color={palette.text} size={16} />
          <Text style={[styles.actionText, { color: palette.text }]}>
            重命名
          </Text>
        </Pressable>
      ...
      >
        ...
        />
        <Pressable
          style={[styles.renameBtn, { backgroundColor: palette.brand }]}
          onPress={doRename}
        >
...
function SessionRow({
  ...
  return (
    <Pressable
      style={[
        styles.sessionRow,
        active && { backgroundColor: palette.brandSoft },
      ]}
      onPress={onPress}
    ...
    >
      ...
      {pinned === true && (
        <AppIcon name="pin" color={palette.brand} size={12} />
      )}
...
function FooterEntry({
  ...
  return (
    <Pressable style={styles.entry} onPress={onPress}>
      ...
      <View style={{ flex: 1 }}>
        <Text style={[styles.entryLabel, { color: palette.text }]}>
          {label}
        </Text>
        {sub !== undefined && (
...
function NewSessionSheet({
  ...
  return (
    ...
    >
      ...
      {error !== null && (
        <Text style={[sheetStyles.hint, { color: palette.error }]}>
          {error}
        </Text>
      )}
      <Pressable
        style={[sheetStyles.browseButton, { borderColor: palette.brand }]}
        onPress={() => setPicker(true)}
      >
        <AppIcon name="chevron-right" color={palette.brand} size={14} />
        <Text style={[sheetStyles.browseText, { color: palette.brand }]}>
          浏览电脑目录…
        </Text>
      </Pressable>
      ...
      <View style={[sheetStyles.addRow, { borderColor: palette.border }]}>
        ...
        />
        <Pressable
          style={[sheetStyles.addBtn, { backgroundColor: palette.brand }]}
          onPress={add}
          disabled={busy}
        >
      ...
      <ScrollView style={sheetStyles.list}>
        {workspaces.map((w) => (
          <Pressable
            key={w.id}
            style={[sheetStyles.item, { borderColor: palette.border }]}
            onPress={() => create(w.path)}
          >
            <Text style={[sheetStyles.itemTitle, { color: palette.text }]}>
              {w.title}
            </Text>
            <Text
              style={[sheetStyles.itemPath, { color: palette.textSecondary }]}
              numberOfLines={1}
            >
              {w.path}
            </Text>
