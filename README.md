...
电脑端托盘菜单 →「配对」，用手机 App 扫一下二维码（或手输 6 位配对码）：

<div align="center"><img src="docs/screenshots/desktop-pairing.png" width="320"><br><sub>托盘菜单 → 配对：扫码即连（示意图，非真实配对码）</sub></div>
...
*托盘菜单 → 状态：Worker 运行情况一览；也可以在这里手动启停*
...
- 🤝 **配对才认你**——手机和电脑靠扫码/配对码建立信任，一台手机一把钥匙；怀疑泄露就点「换配对码」，旧的立刻作废
